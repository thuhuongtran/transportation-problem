...
public class DistributeOrders {
    public static List<String> shipper_order;
    /**
     * call google map api
    ...
    * */
    ...
    public static Distance getDistanceTwoPoints(String track, String oriLat, String oriLot, String desLat, String desLot) throws IOException {
        DistributeOrders request = new DistributeOrders();
        System.out.println(track+" "+oriLat+" "+oriLot+" "+" "+desLat+" "+desLot);
...
//    }
     ...
     *        list of drivers
     * */
    public static void distributeOrders(List<Distance> disLi){
        disLi.sort(new Comparator<Distance>() {
            @Override
            public int compare(Distance o1, Distance o2) {
                return o1.getValueDis().compareTo(o2.getValueDis());
            }
        });
        shipper_order.add(disLi.get(0).getTrack());
        disLi.remove(0);
    }
