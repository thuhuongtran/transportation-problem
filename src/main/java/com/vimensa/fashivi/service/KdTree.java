...
public class KdTree<T extends KdTree.XYZPoint> implements Iterable<T> {
    ...
    public static class XYZPoint implements Comparable<XYZPoint> {
         ...
         * @param id
         */
        public XYZPoint(double x, double y, String id) {
            this.x = x;
            this.y = y;
            this.id = id;
            this.z = 0;
         ...
         * @param z
         */
        public XYZPoint(double x, double y, double z, String id) {
            this.x = x;
            this.y = y;
            this.id = id;
            this.z = z;
         ...
         * @param id
         */
        public XYZPoint(Double latitude, Double longitude, String id) {
